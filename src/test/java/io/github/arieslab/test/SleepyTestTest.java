...
import io.github.arieslab.core.testsmelldetector.testsmell.smell.SleepyTest;
...
public class SleepyTestTest {
	...
	public void setUp() throws Exception {
		...
		fileInputStream = new FileInputStream(new File("src/test/java/io/github/arieslab/test/fixtures/SleepyFixture.java"));
	}	
