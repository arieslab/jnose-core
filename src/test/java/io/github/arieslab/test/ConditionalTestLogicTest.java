...
import io.github.arieslab.core.testsmelldetector.testsmell.smell.ConditionalTestLogic;
...
public class ConditionalTestLogicTest {
	...
	public void setUp() throws Exception {
		...
		fileInputStream = new FileInputStream(new File("src/test/java/io/github/arieslab/test/fixtures/ConditionalFixture.java"));
	}
