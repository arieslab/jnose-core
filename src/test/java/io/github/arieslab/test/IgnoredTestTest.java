...
import io.github.arieslab.core.testsmelldetector.testsmell.smell.IgnoredTest;
...
public class IgnoredTestTest {
	...
	public void setUp() throws Exception {
		...
		fileInputStream = new FileInputStream(new File("src/test/java/io/github/arieslab/test/fixtures/IgnoredFixture.java"));
	}
