...
import io.github.arieslab.core.testsmelldetector.testsmell.smell.UnknownTest;
...
public class UnknownTestTest {
	...
	public void setUp() throws Exception {
		...
		fileInputStream = new FileInputStream(new File("src/test/java/io/github/arieslab/test/fixtures/UnkwonFixture.java"));
	}
