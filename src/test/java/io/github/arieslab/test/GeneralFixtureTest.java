...
import io.github.arieslab.core.testsmelldetector.testsmell.smell.GeneralFixture;
...
public class GeneralFixtureTest {
	...
	public void setUp() throws Exception {
		...
		fileInputStream = new FileInputStream(new File("src/test/java/io/github/arieslab/test/fixtures/GeneralFixtureFixture.java"));
	}
