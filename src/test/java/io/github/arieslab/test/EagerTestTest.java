...
import io.github.arieslab.core.testsmelldetector.testsmell.smell.EagerTest;
...
public class EagerTestTest {
	...
	public void setUp() throws Exception {
		...
		fileInputStream = new FileInputStream(new File("src/test/java/io/github/arieslab/test/fixtures/EagerFixture.java"));
