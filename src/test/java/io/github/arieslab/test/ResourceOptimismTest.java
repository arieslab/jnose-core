...
import io.github.arieslab.core.testsmelldetector.testsmell.smell.ResourceOptimism;
...
public class ResourceOptimismTest {
	...
	public void setUp() throws Exception {
		...
		fileInputStream = new FileInputStream(new File("src/test/java/io/github/arieslab/test/fixtures/ResourceOptimismFixture.java"));
	}	
