...
import io.github.arieslab.core.testsmelldetector.testsmell.smell.EmptyTest;
...
public class EmptyTestTest {
	...
	public void setUp() throws Exception {
		...
		fileInputStream = new FileInputStream(new File("src/test/java/io/github/arieslab/test/fixtures/EmptyFixture.java"));
	}	
