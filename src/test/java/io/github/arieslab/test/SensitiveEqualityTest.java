...
import io.github.arieslab.core.testsmelldetector.testsmell.smell.SensitiveEquality;
...
public class SensitiveEqualityTest {
	...
	public void setUp() throws Exception {
		...
		fileInputStream = new FileInputStream(new File("src/test/java/io/github/arieslab/test/fixtures/SensitiveEqualityFixtureTest.java"));
	}	
