...
import io.github.arieslab.core.testsmelldetector.testsmell.smell.MysteryGuest;
...
public class MysteryGuestTest {
	...
	public void setUp() throws Exception {
		...
		fileInputStream = new FileInputStream(new File("src/test/java/io/github/arieslab/test/fixtures/MisteryGuestFixture.java"));
	}
