...
import io.github.arieslab.core.testsmelldetector.testsmell.smell.RedundantAssertion;
...
public class RedundantAssertionTest {
	...
	public void setUp() throws Exception {
		...
		fileInputStream = new FileInputStream(new File("src/test/java/io/github/arieslab/test/fixtures/RedundantAssertionFixture.java"));
	}	
