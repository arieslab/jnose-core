...
import io.github.arieslab.core.testsmelldetector.testsmell.smell.PrintStatement;
...
public class PrintStatementTest {
	...
	public void setUp() throws Exception {
		...
		fileInputStream = new FileInputStream(new File("src/test/java/io/github/arieslab/test/fixtures/PrintStatmentFixture.java"));
	}
