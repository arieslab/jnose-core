...
import io.github.arieslab.core.testsmelldetector.testsmell.smell.MagicNumberTest;
...
public class MagicNumberTestTest {
	...
	public void setUp() throws Exception {
		...
		fileInputStream = new FileInputStream(new File("src/test/java/io/github/arieslab/test/fixtures/MagicNumberFixture.java"));
	}	
