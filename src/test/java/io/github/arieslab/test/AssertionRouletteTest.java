...
import io.github.arieslab.core.testsmelldetector.testsmell.smell.AssertionRoulette;
...
public class AssertionRouletteTest {
	...
	public void setUp() throws Exception {
		...
		fileInputStream = new FileInputStream(new File("src/test/java/io/github/arieslab/test/fixtures/AssertionRouletteFixture.java"));
	}
